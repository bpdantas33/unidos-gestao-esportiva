      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <aside className="lg:col-span-4 bg-white p-6 rounded-xl shadow-sm border border-outline-variant/30 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-4 text-left">
              ...
              <p className="text-xs text-on-surface-variant mt-1 font-medium">
                {nextMatch?.address ?? getStadiumAddress(nextMatch?.stadium)}
              </p>
            </div>
            ...
            <div className="w-full h-44 rounded-lg overflow-hidden border border-outline-variant/40 bg-surface-container relative my-4">
              <iframe
                ...
                src={`https://maps.google.com/maps?q=${encodeURIComponent(nextMatch?.address ?? getStadiumAddress(nextMatch?.stadium))}&t=&z=15&ie=UTF8&iwloc=&output=embed`}
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <button
              onClick={() => handleCopyAddress(nextMatch?.address ?? getStadiumAddress(nextMatch?.stadium))}
            ...
            <a
              href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(nextMatch?.address ?? getStadiumAddress(nextMatch?.stadium))}`}
              target="_blank"
